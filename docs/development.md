Development of pyqgis-advanced-workshop plugin
===========================
...
`git clone --recurse-submodules https://github.com/GispoCoding/pyqgis-advanced-workshop.git`
...
The code for the plugin is in the [testplugin](../pyqgis-advanced-workshop) folder. Make sure you have required tools, such as
Qt with Qt Editor and Qt Linquist installed by following this
[tutorial](https://www.qgistutorials.com/en/docs/3/building_a_python_plugin.html#get-the-tools).

For building the plugin use platform independent [build.py](../pyqgis-advanced-workshop/build.py) script.

## Setting up development environment

To get started with the development, follow these steps:

1. Go to the  [testplugin](../pyqgis-advanced-workshop) directory with a terminal
...
* they contain absolute imports:
    ```python
    from testplugin.utils.exceptions import TestException # Good
...
Edit [build.py](../testplugin/build.py) to contain working values for *profile*, *lrelease* and *pyrcc*. If you are
...
* Add this badge ![](https://github.com/GispoCoding/pyqgis-advanced-workshop/workflows/Translations/badge.svg) to
...
The translation files are in [i18n](../pyqgis-advanced-workshop/resources/i18n) folder. Translatable content in python files is
